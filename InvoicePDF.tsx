...
Font.register({
  family: 'Lato',
  fonts: [{ src: '/fonts/Lato-Regular.ttf' }, { src: '/fonts/Lato-Bold.ttf', fontWeight: 700 }],
})
  ...
  const leseeFinalDetails = () => {
    return (
      <>
        ...
        <Text style={classes.details}>{translations.guestNotes.securityDepositInfo}</Text>
        ...
        <Text style={classes.details}>{translations.guestNotes.overCapacity3}</Text>
  ...
  const ownerFinalDetails = () => {
    return (
      <>
        ...
        <View style={classes.tableColumn}>
          <View style={classes.row}>
            <Text style={[classes.cell, classes.black]}>{translations.guestPays}:</Text>
            <View style={classes.right}>
              <Text style={classes.cellFlex}>{reservation.total}</Text>
            </View>
          </View>
          <View style={[classes.row, classes.line]}>
            <Text style={[classes.cell, classes.larger]}>{translations.serviceFee}</Text>
            <View style={classes.right}>
              <Text style={classes.cellFlex}>{financialDetails.serviceFee}</Text>
            </View>
          </View>
          <View style={classes.row}>
          ...
          <View style={classes.tableNoMargin}>
            ...
            <View style={classes.subTable}>
              ...
              <View style={classes.subTableRow}>
                ...
                <View style={classes.right}>
                  <Link src={'www.sundes.com/cancellation-policy'} style={classes.cellFlex}>
